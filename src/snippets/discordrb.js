  ...
  generateFrom(data) {
    ...
    if (data.embed) {
      ...
      if (data.embed.image) {
        ...
        result.push(`  embed.image = Discordrb::Webhooks::EmbedImage.new(${rubyKwargs(args)})`);
      }
      ...
      if (data.embed.thumbnail) {
        ...
        result.push(`  embed.thumbnail = Discordrb::Webhooks::EmbedThumbnail.new(${rubyKwargs(args)})`);
      }
      ...
      if (data.embed.author) {
        ...
        result.push(`  embed.author = Discordrb::Webhooks::EmbedAuthor.new(${rubyKwargs(args)})`);
      }
      ...
      if (data.embed.footer) {
        ...
        result.push(`  embed.footer = Discordrb::Webhooks::EmbedFooter.new(${rubyKwargs(args)})`);
      }
